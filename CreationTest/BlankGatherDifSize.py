...
def blanks_do(FOVS1, FOVS2):
    ...
    NumFOVs = 5000 # How many FOVs to extract from the raw data.
    ...
    DataFile = h5py.File('/home/admin/Desktop/Aug6/new_to_train_{}x{}.hdf5'.format(FOVS1, FOVS2), 'w')
    DataFile.attrs['TrainTestValSplit'] = TrainTestValSplit
    DataFile.attrs['FOVSize'] = (FOVS1, FOVS2)
    ...
    compression_opts = 2
    TrainYes = DataFile.create_dataset('TrainYes', (NumTrain, FOVS1, FOVS2), dtype='f8', chunks=True, compression='gzip', compression_opts=compression_opts)
    TrainNo  = DataFile.create_dataset('TrainNo',  (NumTrain, FOVS1, FOVS2), dtype='f8', chunks=True, compression='gzip', compression_opts=compression_opts)

    TestYes  = DataFile.create_dataset('TestYes', (NumTest, FOVS1, FOVS2), dtype='f8', chunks=True, compression='gzip', compression_opts=compression_opts)
    TestNo   = DataFile.create_dataset('TestNo',  (NumTest, FOVS1, FOVS2), dtype='f8', chunks=True, compression='gzip', compression_opts=compression_opts)

    ValYes   = DataFile.create_dataset('ValYes', (NumVal, FOVS1, FOVS2), dtype='f8', chunks=True, compression='gzip', compression_opts=compression_opts)
    ValNo    = DataFile.create_dataset('ValNo',  (NumVal, FOVS1, FOVS2), dtype='f8', chunks=True, compression='gzip', compression_opts=compression_opts)
